...
public class TestLab1 {
    ...
    public void testRandomizedSort() {
        XYPoint[] points = Lab1.genPointsAtRandom(20, new Random());
        XYPoint pointsByX[] = new XYPoint[20];
        XYPoint pointsByXExpected[] = new XYPoint[20];
        XYPoint pointsByY[] = new XYPoint[20];
        XYPoint pointsByYExpected[] = new XYPoint[20];
    ...
    public void testClosestPair() {
        ...
        lab1.Result rMinExpect = ClosestPair.findClosestPairBruteForce(pointsByXExpected, pointsByYExpected);
        long startTime = System.currentTimeMillis();
        ...
        //System.out.println("" + rMinExpect.dist + rMin.dist);
