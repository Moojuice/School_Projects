    ...
    public FileParser(String fileName) {
    	...
    	try {
    		if (fileName.equals("airports")) {	
    			//SetGUI.class.getResource("/lab5/client/mediumcards/backgroundrescaled.png")
    			InputStream is = new FileInputStream(FileParser.class.getResource("/lab3/airports").getFile());
                Reader r = new BufferedReader(new InputStreamReader(is));
                tokenizer = new StreamTokenizer(r);
                tokenizer.eolIsSignificant(true);
    		}
    		if (fileName.equals("flights")) {
    			InputStream is = new FileInputStream(FileParser.class.getResource("/lab3/flights").getFile());
                Reader r = new BufferedReader(new InputStreamReader(is));
                tokenizer = new StreamTokenizer(r);
                tokenizer.eolIsSignificant(true);
    		}
